                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <img src="img/logo.png" alt="Carlos Fernandez de Castro" class="responsive mb-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="recordar-contrasena.html">Olvide la Contraseña</a> | <a class="small" href="#">Asistencia Técnica</a>
                                    </div>
                                </div>
                            </div>
                        </div>
