...
<head>
    ...
    <title>Eps - listado De Eps</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    {{-- MODALES --}}
                    @include('modal.epscreate')
                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">EPS</h1>
                        <div>
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a type="button" data-toggle="modal" data-target="#epscreate"
                                        class="dropdown-item"><i class="fas fa-fw fa-calendar-alt mr-1"></i>Eps</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Listado De Eps</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    {{-- ALERTAS --}}
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-sm" id="PacienteListar" width="100%"
                                            ...
                                            <tbody>
                                                @foreach ($eps as $list)
                                                    <tr>
                                                        <td>{{ $list->eps_nombres }}</td>
                                                        <td>
                                                            <a type="button" data-toggle="modal"
                                                                data-target="#conveniosedit{{ $list->eps_id }}"
                                                                class="btn btn-secondary btn-circle btn-sm"><i
                                                                    class="fas fa-pencil-alt fa-sm"></i></a>

                                                            <form action="{{ route('eps.delete', $list->eps_id) }}"
                                                                ...
                                                                <button type="submit"
                                                                    ...
                                                                    rel="tooltip"
                                                                    onclick="return confirm('Seguro que quiere eliminar esta Eps?') ">
